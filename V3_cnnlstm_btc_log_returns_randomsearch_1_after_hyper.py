...
# The target is created with log_return.shift(-horizon).
# For this file, the default horizon is t+1.
#
...
# The output filename reflects the CNN-LSTM after-hyper t+1 experiment.
...
# Run the complete CNN-LSTM after-optimisation pipeline
# ==============================================================================
# This is the main controller function for the experiment.
# It loads data, creates the target, builds features, and splits the data.
...
def cnnlstm_forecast(horizon: int = FORECAST_HORIZON) -> None:
    ...
    To run for multiple horizons, call cnnlstm_forecast() multiple times,
    e.g.: cnnlstm_forecast(1); cnnlstm_forecast(7); cnnlstm_forecast(30)
