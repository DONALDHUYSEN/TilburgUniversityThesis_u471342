...
# The t+7 target is created with log_return.shift(-7).
# This means the model predicts the single daily return 7 days ahead.
#
...
# It loads data, creates the t+7 target, builds features, and splits the data.
