...
# === Settings ===
csv_path = "xgboost_test_predictions_t30.csv"
prediction_col = "predicted_log_return"
output_path = "feature_correlation_barplot_FvP_t30.png"


# Zet op True als je ook feature_lag1 wilt meenemen
...
wanted_features = [
    ...
    "dxy_close_adjusted","nikkei_close_adjusted","asset","AdrActCnt",
...
plt.ylabel("Features")
plt.title("Feature Correlations with Prediction Horizon 30")
