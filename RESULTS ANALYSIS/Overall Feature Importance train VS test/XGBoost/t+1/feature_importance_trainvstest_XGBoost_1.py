...
model_path = "xgb_model_t1.json"
output_path = "XGBoost_SHAP_train_vs_test_t1_normalized.png"

title = "Normalized SHAP Feature Importance: XGBoost Train vs Test Horizon 1"
