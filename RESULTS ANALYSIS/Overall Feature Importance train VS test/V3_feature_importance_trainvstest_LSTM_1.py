...
# === Settings ===
train_csv_path = "train_t1.csv"
test_csv_path = "test_t1.csv"
model_path = "lstm_model_t1.keras"
scaler_path = "scaler_tv_t1.joblib"
feature_cols_path = "feature_cols_t1.txt"
output_path = "V3_LSTM_SHAP_train_vs_test_t1_normalized.png"
...
title = "Normalized SHAP Feature Importance: LSTM Train vs Test Horizon 1"
