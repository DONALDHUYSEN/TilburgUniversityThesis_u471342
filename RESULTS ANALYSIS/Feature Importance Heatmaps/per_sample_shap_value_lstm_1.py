...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bereken per-sample SHAP values voor LSTM t+1."
    )

    parser.add_argument("--train", default="train_t1.csv")
    parser.add_argument("--test", default="test_t1.csv")
    parser.add_argument("--model", default="lstm_model_t1.keras")
    parser.add_argument("--scaler", default="scaler_tv_t1.joblib")
    parser.add_argument("--output-dir", default="outputs_lstm_t1")
