...
# === Paths ===
shap_path = "per_sample_shap_values_normalized_cnnlstm_30.csv"
feature_names_path = "feature_names_cnnlstm_30.json"
metadata_path = "per_sample_shap_metadata_cnnlstm_30.json"

output_path = "V2_normalized_per_sample_shap_heatmap_cnnlstm_30.png"
...
plt.ylabel("Features")
plt.title("CNN-LSTM: Normalized Feature Importance Over Combined Train and Test Samples t+30")
