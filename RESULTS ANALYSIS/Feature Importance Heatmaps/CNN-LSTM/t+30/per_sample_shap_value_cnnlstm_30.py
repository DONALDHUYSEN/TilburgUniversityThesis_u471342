...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bereken per-sample SHAP values voor CNN-LSTM t+30."
    )

    parser.add_argument("--train", default="train_t30.csv")
    parser.add_argument("--test", default="test_t30.csv")
    parser.add_argument("--model", default="cnnlstm_model_t30.keras")
    parser.add_argument("--scaler", default="cnnlstm_scaler_t30.joblib")
    parser.add_argument("--output-dir", default="outputs_cnnlstm_t30")
