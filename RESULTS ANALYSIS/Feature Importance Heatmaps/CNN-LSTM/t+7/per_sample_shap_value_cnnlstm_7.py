...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bereken per-sample SHAP values voor CNN-LSTM t+7."
    )

    parser.add_argument("--train", default="train_t7.csv")
    parser.add_argument("--test", default="test_t7.csv")
    parser.add_argument("--model", default="cnnlstm_model_t7.keras")
    parser.add_argument("--scaler", default="cnnlstm_scaler_t7.joblib")
    parser.add_argument("--output-dir", default="outputs_cnnlstm_t7")
