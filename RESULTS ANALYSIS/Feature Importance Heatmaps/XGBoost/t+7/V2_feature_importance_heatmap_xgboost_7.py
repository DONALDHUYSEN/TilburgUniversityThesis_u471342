...
# === Paths ===
shap_path = "per_sample_shap_values_normalized_xgboost_7.csv"
feature_names_path = "feature_names_xgboost_7.json"
metadata_path = "per_sample_shap_metadata_xgboost_7.json"

output_path = "V2_normalized_per_sample_shap_heatmap_xgboost_7.png"
...
plt.ylabel("Features")
plt.title("XGBoost: Normalized Feature Importance Over Combined Train and Test Samples t+7")
