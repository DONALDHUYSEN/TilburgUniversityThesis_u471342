...
EXCLUDE_PRESETS = [
    DEFAULT_EXCLUDE_COLUMNS,
    {"Date", "asset", "target_log_return_t_plus_7", "log_return"},
    {"Date", "asset", "target_log_return_t_plus_7", "Close"},
    {"Date", "asset", "target_log_return_t_plus_7"},
]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bereken per-sample SHAP values voor XGBoost t+7."
    )
    parser.add_argument("--train", default="train_t7.csv")
    parser.add_argument("--test", default="test_t7.csv")
    parser.add_argument("--model", default="xgb_model_t7.json")
    parser.add_argument("--output-dir", default="outputs_t7")
